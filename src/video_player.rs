...
use crate::channel_player::{
    AudioVisualization, ChannelPlayer, PlaybackState, PlayerEvent, SeekDirection, SubtitleTrack,
};
...
pub fn register_player_and_run(video_player: VideoPlayer, args: &Vec<std::string::String>) {
    let app = &video_player.app;
    app.start();

    let gtk_app = app.as_gtk_application().unwrap();
...
impl VideoPlayer {
    ...
    pub fn start(&mut self) {
        ...
        self.app.set_video_renderer(self.player.video_renderer());
